...
### MS references 
MS recommendations below is just subset of many examples - **The emphasis is to highlight the significance on choosing between Azure AD and non-Azure AD authentication options Azure services.**
